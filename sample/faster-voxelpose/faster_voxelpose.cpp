...
class pre_project_whole_node : public graph_node {
 ...
 public:
  ...
  virtual std::string get_proc_name() const override { return "pre_project_whole"; }
...
class project_whole_node : public graph_node {
 ...
 public:
  ...
  virtual std::string get_proc_name() const override { return "project_whole"; }
...
class center_decode_node : public graph_node {
 ...
 public:
  ...
  virtual std::string get_proc_name() const override { return "center_decode"; }
...
class project_individual_node : public graph_node {
 ...
 public:
  ...
  virtual std::string get_proc_name() const override { return "project_individual"; }
...
class project_orthogonal_node : public graph_node {
 ...
 public:
  ...
  virtual std::string get_proc_name() const override { return "project_orthogonal"; }
...
class fusion_node : public graph_node {
 ...
 public:
  ...
  virtual std::string get_proc_name() const override { return "fusion"; }

...
CEREAL_REGISTER_TYPE(encode_jpeg_node)
CEREAL_REGISTER_POLYMORPHIC_RELATION(graph_node, encode_jpeg_node)
...
CEREAL_REGISTER_TYPE(decode_jpeg_node)
CEREAL_REGISTER_POLYMORPHIC_RELATION(graph_node, decode_jpeg_node)

...
TEST(TensorTest, TestConstruct2)
{
    ...
    ASSERT_EQ(tensor.at({0, 0, 0, 0}), 1);
    ASSERT_EQ(tensor.at({1, 1, 0, 0}), 5);
    ASSERT_EQ(tensor.at({2, 1, 0, 0}), 6);
}
...
TEST(TensorTest, TestConstruct3)
{
    ...
    ASSERT_EQ(tensor.at({0, 0, 0, 0}), 1);
    ASSERT_EQ(tensor.at({1, 1, 0, 0}), 5);
    ASSERT_EQ(tensor.at({1, 2, 0, 0}), 6);
    ASSERT_EQ(tensor.at({2, 1, 0, 0}), 8);
    ASSERT_EQ(tensor.at({2, 2, 0, 0}), 9);
}
...
TEST(TensorTest, TestTransform1)
{
    ...
    ASSERT_EQ(result.at({0, 0, 0, 0}), 2);
    ASSERT_EQ(result.at({1, 1, 0, 0}), 7);
    ASSERT_EQ(result.at({2, 1, 0, 0}), 8);
    ASSERT_EQ(result.at({2, 2, 0, 0}), 12);
}
...
TEST(TensorTest, TestTranspose1)
{
    ...
    ASSERT_EQ(result.at({0, 0, 0, 0}), 1);
    ASSERT_EQ(result.at({1, 1, 0, 0}), 5);
    ASSERT_EQ(result.at({1, 2, 0, 0}), 6);
    ASSERT_EQ(result.at({2, 1, 0, 0}), 8);
    ASSERT_EQ(result.at({2, 2, 0, 0}), 9);
}